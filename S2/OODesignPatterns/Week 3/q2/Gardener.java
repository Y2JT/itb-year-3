...
implements ActionListener {
    ...
    private void setCenter() {
        if (garden != null) centerPlant = garden.getCenter().getName() + garden.getCenter().getSoil();
        // repaints garden panel
        gardenPlot.repaint();
    }
    private void setBorder() {
        if (garden != null) borderPlant = garden.getBorder().getName() + garden.getBorder().getSoil();
        gardenPlot.repaint();
    }
    private void setShade() {
        if (garden != null) shadePlant = garden.getShade().getName() +  garden.getShade().getSoil();
        gardenPlot.repaint();
    }
