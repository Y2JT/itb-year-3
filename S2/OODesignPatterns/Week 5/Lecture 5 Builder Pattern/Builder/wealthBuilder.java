...
public class wealthBuilder extends JxFrame
  implements ListSelectionListener, ActionListener {
    ...
    private void buildStockLists() {
        ...
        JapaneseStock.addElement("Bandai");
        JapaneseStock.addElement("Nintendo");
        JapaneseStock.addElement("Capcom");
        JapaneseStock.addElement("Konami");
        JapaneseStock.addElement("A Bathing Ape");
